...
更新日: 2025-08-19（insert_sustain 実装・README更新・テスト緑／追記合成とformat明示の定着）
...
11. [ ] R2: transform_midi（最小: transpose → 次: quantize/tempo/humanize）
...
- [x] ドキュメント: README 追記と `docs/prompts/claude_test_prompts_v8_score_dsl.md` 追加
 ...
 - [ ] slur/legato 時のCC64自動付与プリセット（オプション）を検討（現在は `insert_sustain` で事後付与可能）
